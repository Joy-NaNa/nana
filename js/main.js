...
$(function() {
  var bookmark = {
    data: [{
      name: '影视资源一号',
      link: 'https://w.wxbxkx.com/',
      box_shadow: '#F18033',
      icon: 'img/log.png',
    }, {
      name: '影视资源二号',
      link: 'http://520.loveqindy.com/',
      box_shadow: '#11B063',
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "胖橘导航 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "胖橘导航 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "胖橘导航 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "胖橘导航 | Stay up late again";
}
//title问候语结束
